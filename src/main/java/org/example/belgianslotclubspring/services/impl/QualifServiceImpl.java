...
public class QualifServiceImpl implements QualifService {
    ...
    public List<Qualif> getQualifByDate(LocalDate selectedDate) {
        throw new UnsupportedOperationException("Utiliser getQualifByDateAndClub(date, club)");
    }

    @Override
    public List<Qualif> getQualifByDateAndClub(LocalDate selectedDate, String club) {
        String clubCode = Club.requireCode(club);
        return qualifRepo.getQualifByDateAndClub(selectedDate, clubCode);
    }
}
